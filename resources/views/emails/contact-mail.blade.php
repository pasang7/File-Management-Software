...
<head>
    ...
    <!-- SITE TITLE -->
    <title>Contact | 1905 Suites & Restaurant</title>
...
<div>
    ...
    <div style="padding: 15px;letter-spacing: 0.2px;">
        ...
        @endif
        <h4>
            Name:&nbsp;<span style="font-weight:bold;font-size: 16px;color: #1329c3;text-transform: uppercase;"> {{$name}}</span><br>
            Phone:&nbsp;<span style="font-weight:bold;"> {{$phone}}</span><br>
            @if($from)Email:&nbsp;<span style="font-weight:bold;"> {{$from}}</span><br>@endif
            Address:&nbsp;<span style="font-weight:bold;"> {{$address}}</span><br>
        </h4>
    </div>
</div>
</body>

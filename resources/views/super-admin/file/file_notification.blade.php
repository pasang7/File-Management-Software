                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <div class="text-right">
                                                <a href="{{route('file.index')}}"><button type="button" class="btn btn-outline-dark"><i class="fas fa-file"></i> File History</button></a>
                                                <a href="{{route('view.all-notification')}} "><button type="button" class="btn btn-outline-info"><i class="fas fa-bell"></i> All Notification</button></a>
                                            </div>
                                        </div>
                                        <div class="card-block">
                                            <div class="table-responsive">
                                                <table  class="table table-hover todo-list ui-sortable">
                                                    <thead>
                                                    <tr>
                                                        <th>File</th>
                                                        <th>Description</th>
                                                        ...
                                                        <tr id="{{$file->id}}">
                                                            ...
                                                            <td>
                                                                ...
                                                                @if(Auth::user()->id == $file->user_id)
                                                                    ...
                                                                    <button type="button" class="btn btn-icon btn-rounded btn-outline-danger" data-toggle="modal" data-target="#deleteModal-{{$file->id}}"><i class="fas fa-trash"></i></button>
                                                                    <!-- delete -->

                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    ...
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="javascript:">Add Menu</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    </div>
                    <form method="post" action="{{route('nav.store')}}" enctype="multipart/form-data" autocomplete="off" data-parsley-validate novalidate>
                        {!! csrf_field() !!}
...
@section('page-specific-scripts')
    ...
    <script type="text/javascript">
        function changeType(type) {
            ...
            $.ajax({
                method: 'POST',
                url: '{{ route('nav.change-type-create') }}',
                data: {
                    '_token': '{{ csrf_token() }}',
                    type: type,
                },

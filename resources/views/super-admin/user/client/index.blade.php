                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        ...
                                        <div class="button-card text-right">
                                            <a href="{{route('client.create')}}"><button type="button" class="btn btn-dark"><i class="fas fa-plus"></i> Add Client</button></a>
                                        </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover">
                                                    ...
                                                    <tr class="unread">
                                                        ...
                                                        <td><a href="{{route('client.edit',$user->id)}}" ><i class="fas fa-edit"></i></a>
                                                                ...
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <a href="{{route('client.destroy',$user->id)}}" class="btn btn-danger">Delete</a>
